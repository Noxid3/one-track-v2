...
A live, gamified performance dashboard built for a real retail site — a petrol station. Staff performance data lives in a Google Sheet; this dashboard turns it into a leaderboard, trend charts, and department "champions" display, refreshed automatically and rendered for a wall-mounted TV.
